...
class Column implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets data_type
     *
     * @param string $data_type The data type of the column as documented https://docs.singlestore.com/v7.3/reference/sql-reference/datatypes/
     *
     * @return self
     */
     ...
     * Sets nullable
     *
     * @param bool $nullable \"true\" if the value can be null, \"false\" otherwise
     *
     * @return self
     */
