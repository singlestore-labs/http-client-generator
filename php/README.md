...
Please see example code in "example.php".

This client was generated by Openapi Generator (https://github.com/openapitools/openapi-generator).
...
```php
<?php
require_once('/path/to/SingleStoreClient/vendor/autoload.php');
```
